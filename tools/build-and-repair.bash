...
pip install --progress-bar off scikit-build-core numpy scipy_openblas32 auditwheel patchelf
...
echo "--Repair"
LD_LIBRARY_PATH=$OPENBLAS_DIR auditwheel repair --wheel-dir $workdir/wheelhouse $workdir/inwheels/f77ex*.whl
